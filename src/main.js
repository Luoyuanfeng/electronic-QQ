...
class ElectronicWeChat {
    ...
    initIPC() { //loading界面
        ...
        console.log("ipcmain on badge-changed")
            //用于状态变化，需要提示未读消息的时候
    ...
    //创建各种窗口
    createTray() {
        console.log("on crear tray")
        this.tray = new AppTray(this.splashWindow, this.wechatWindow);
    }

    createSplashWindow() {
        console.log("on crear splash window")
        this.splashWindow = new SplashWindow();
        this.splashWindow.show();
    }

    createWeChatWindow() {
        console.log("on crear wechat window")
